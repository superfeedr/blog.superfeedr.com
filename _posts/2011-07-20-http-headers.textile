...
It's one of the small tricks we're the proudest, but it's also a well hidden gem, so I'd like to take a couple seconds to introduce you to the HTTP headers we send on PubSubHubbub notifications.
