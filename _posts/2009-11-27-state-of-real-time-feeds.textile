...
As "promised last month":/real-time/statistics/market/state-of-real-time-feeds/, here is a small update on the *real-time feeds market*.
...
If you were building a similar infrastructure to ours, assuming you'd support "PubSubHubbub":http://push.superfeedr.com/, "RSSCloud":http://blog.superfeedr.com/rsscloud/api/pubsubhubbub/RSSCloud/ and "SUP":http://blog.superfeedr.com/sup/pubsubhubbub/xmpp/real-time/SUP-over-pubsubhubb-and-xmpp/ [1], here is the breakdown that you would get.
