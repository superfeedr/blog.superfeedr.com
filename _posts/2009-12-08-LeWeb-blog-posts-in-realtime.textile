...
alias: /OSS/collectd/infrastructure/open-source/performance-monitoring-with-collectd/
---
...
To make it a little nicer, I *extracted* a few information from the "standard entry schema":http://documentation.superfeedr.com/schema.html#entry : author name and link, as well as categories. With the *categories*, I did some filtering to make sure we only publish stories that either mention LeWeb or explictly declare that as a tag.
