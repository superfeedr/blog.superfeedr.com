...
alias: /activity/pubsubhubbub/streams/activity-streams/
tags: [openweb, activitystreams]
description: "ActivityStreams are a key component of the social web. Superfeedr is able to process them as feeds."
---
