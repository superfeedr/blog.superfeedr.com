...
EventVue uses "PHP":http://php.net/index.php and the "PubSubHubbub API":http://documentation.superfeedr.com/subscribers.html#webhooks. I'll just let Josh saying what he likes about Superfeedr :
