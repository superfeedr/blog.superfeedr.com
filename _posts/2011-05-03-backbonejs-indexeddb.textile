...
Unfortunately, localStorage is pretty limited and doesn't work well for complex data. We hope that *IndexedDB* quickly grows and fits the needs of many web apps. Please make sure you consult the "README file":https://github.com/superfeedr/indexeddb-backbonejs-adapter/blob/master/README.markdown to learn more. Also, feel free to fork it and make it better! Feel free to "run the tests with your browser":http://blog.superfeedr.com/indexeddb-backbonejs-adapter/tests.html to see if IndexedDB is supported!
