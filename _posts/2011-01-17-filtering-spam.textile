...
Spam feeds usually share a pretty common feature : they're verbose and will likely publish tens of stories daily. Today we "release a feature that will be useful to filter out those spam feeds":http://superfeedr.com/documentation#notification_threshold.
